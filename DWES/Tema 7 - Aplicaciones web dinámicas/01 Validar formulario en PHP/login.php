...
<head>
    <?php require 'validar.php'; //Incluimos la página que nos realizará la validación en PHP?>
    <meta charset="UTF-8">
                ...
                <div class="card-body">
                    <form name='login' method='POST' action='<?php echo $_SERVER['PHP_SELF']; ?>'>
                        <div class="input-group form-group">
                            ...
                            <span id='errUsu' for='usu' class='<?php 
                            //Operador ternario
                            //Sólo si no se le ha dado al botón enviar, se evalua la segunda proposición
                            //Si se validan las variables pass1 y pass2, se imprime la clase d-none que no muestra aviso
                            //Si no se validan, la clase muestra el texto en rojo
                            echo (!isset($_POST['enviar']) || validarNombre($_POST['usu'])) ? "d-none" : "input-group form-group text-danger" ?>'>
                        ...
                        <span id='errPass' for='pass2' 
                            class='<?php 
                            //Los elementos span permanecen ocultos, salvo que no se produzca validación
                            //Operador ternario
                            //Sólo si  se le ha dado al botón enviar, se evalua la segunda proposición
                            //Si se validan las variables pass1 y pass2, se imprime la clase d-none que no muestra aviso
                            //Si no se validan, la clase muestra el texto en rojo
                            echo (!isset($_POST['enviar']) || validarPasswords($_POST['pass1'], $_POST['pass2'])) ? "d-none" : "input-group form-group text-danger" ?>'>
