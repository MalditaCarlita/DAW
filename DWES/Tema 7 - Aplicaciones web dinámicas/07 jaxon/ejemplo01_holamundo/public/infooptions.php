...
echo 'js.app.file=' . $jaxon->getOption('js.app.file') . PHP_EOL;
echo 'js.app.export=' . $jaxon->getOption('js.app.export') . PHP_EOL;
echo 'js.app.minify=' . $jaxon->getOption('js.app.minify') . PHP_EOL;
echo 'js.app.options=' . $jaxon->getOption('js.app.options') . PHP_EOL;
echo 'core.upload.enabled=' . $jaxon->getOption('core.upload.enabled') . PHP_EOL;
echo 'core.annotations.enabled=' . $jaxon->getOption('core.annotations.enabled') . PHP_EOL;
