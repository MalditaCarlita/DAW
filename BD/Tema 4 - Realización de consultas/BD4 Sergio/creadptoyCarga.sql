...
-- Creamos la tabla CENTRO y le insertamos los valores.
CREATE TABLE CENTRO(
...
-- Creamos la tabla DPTO y le insertamos los valores.
CREATE TABLE DPTO(
...
-- Creamos la tabla empleado y le insertamos los valores.
...
-- Modificamos las tablas agregando restricciones.
...
-- Creamos la tabla categoria y le insertamos los valores.
